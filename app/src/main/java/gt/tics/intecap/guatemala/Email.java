...
public class Email extends Activity implements View.OnClickListener {
    ...
    private void iniciaVars() {
        ...
        lee = (EditText) findViewById(R.id.etGusta_leer);
    ...
    public void onClick(View v) {
        convertirEditTextCadena();
        String direccion_correo[]= {sCorreo};
        String mensaje = "Hola a todos " + " mi nombre es " + sNombre + " y quiero decir " + sIntro + " y lo que me gusta hacer es "+ sHace + " y mi lectura favorita es "+ sLee+ " ademas me gusta comer "+ sCome+ "\n" + " ...Esperamos que todo funcione, correctamente.";
    ...
    private void convertirEditTextCadena() {
